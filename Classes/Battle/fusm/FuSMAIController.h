...
#ifndef __Lequworld_SuperWarriors_FuSMAIController_H__
#define __Lequworld_SuperWarriors_FuSMAIController_H__
...
// FuSM AI控制器类
class FuSMAIController : public AIController
{
public:
	//constructor/functions
	FuSMAIController(AIObj* obj);
	~FuSMAIController();
	...
	//FuSM AI控制器的状态机
	CC_SYNTHESIZE_READONLY(FuSMMachine*, m_machine, Machine);
	//FuSM AI控制的对象数据
