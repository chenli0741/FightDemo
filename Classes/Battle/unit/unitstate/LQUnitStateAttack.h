#ifndef __SuperWarriors__LQUnitStateAttack__
#define __SuperWarriors__LQUnitStateAttack__

#include "../LQCombatUnit.h"

//战斗单元攻击状态
class LQUnitStateAttack : public FSMState
{
public:
    //constructor/functions
    LQUnitStateAttack(AIController* parent):FSMState(FUSM_STATE_ATTACK,parent){}
	void enter();       //进入状态时运行
    void exit();        //离开状态时运行
